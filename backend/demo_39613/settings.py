"""
Django settings for demo_39613 project.
...
WSGI_APPLICATION = 'demo_39613.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demo_39613 API",
    "DESCRIPTION": "API documentation for demo_39613 App",
    "VERSION": "v1",
}
